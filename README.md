...
```text
├── api_export_csv.py      # Microserviço API (FastAPI) para rodar em segundo plano no servidor
└── export_hosts.py        # Script CLI interativo para gerar planilhas formatadas (.xlsx) localmente
```
